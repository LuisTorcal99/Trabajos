using ExamenFinalApi.AutoMapper;
using ExamenFinalApi.Data;
using ExamenFinalApi.Repository;
...
builder.Services.AddScoped<IObjetoDosRepository, ObjetoDosRepository>();
builder.Services.AddScoped<IObjetoTresRepository, ObjetoTresRepository>();
